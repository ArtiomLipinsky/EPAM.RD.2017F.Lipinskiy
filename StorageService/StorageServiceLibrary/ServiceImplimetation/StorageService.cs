...
namespace StorageServiceLibrary
{
    ...
    public class StorageService<T> : MarshalByRefObject, IMasterService<T>, ISlaveService<T> where T : IUnique, ICloneable
    {
        ...
        public void Add(T item)
        {
            ...
            changeEvent(this, new ChangeMessageEventArgs<T>(Actions.Add, item));
        ...
        public void Remove(T item)
        {
            ...
            changeEvent(this, new ChangeMessageEventArgs<T>(Actions.Remove, item));
        ...
        {
            master.changeEvent += MasterChangeEvent;
        ...
        public void MasterChangeEvent(object sender, ChangeMessageEventArgs<T> e)
        {
            if (e.Action == Actions.Add) foreach (T item in e.Argument) { container.Add(item); };
            if (e.Action == Actions.Remove) foreach (T item in e.Argument) { container.Remove(item); };
        }
